...
**KieeKey v1.0** is a modern, low-latency Vietnamese input method engine
...
| Area | OpenKey 2.0.5 (upstream) | KieeKey v1.0 |
|---|---|---|
...
**KieeKey v1.0** là bộ gõ Tiếng Việt cho Windows, được xây dựng dựa trên
