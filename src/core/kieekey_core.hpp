...
#define OPENKEY_KIEEKEY_VERSION_STRING "1.3.0-beta8fix1"
...
#include "Progression.hpp"      // v1.3.0: Global Level & Progression
#include "TypingAnalytics.hpp"  // v1.3.0: Real-time Analytics & Coach
