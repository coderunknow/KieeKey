...
//============================================================================
//----------------------------------------------------------------------------
// KieeKey v1.2.0 Stable — demo main.cpp (Windows console)
//
...
void draw(const std::wstring& text, InputMethod method, bool diag) {
    ...
    std::wprintf(L"  KieeKey v1.2.0 Stable - engine demo      [%s]   (F2: %s | F3: diag | Esc: clear | Ctrl+C: quit)\n",
...
int wmain() {
    ...
    ::SetConsoleTitleW(L"KieeKey v1.2.0 Stable - engine demo");
