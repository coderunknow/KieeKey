...
[[maybe_unused]] constexpr wchar_t kAppVersionFull[] = L"1.3.0 Stable";  // with channel
constexpr wchar_t kAppTitle[]       = L"KieeKey v1.3.0 Stable";  // sync with kAppVersionFull
