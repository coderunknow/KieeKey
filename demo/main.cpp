...
//============================================================================
//----------------------------------------------------------------------------
// KieeKey v1.1.1 — demo main.cpp (Windows console)
//
...
void draw(const std::wstring& text, InputMethod method, bool diag) {
    ...
    std::wprintf(L"  KieeKey v1.1.0 - engine demo      [%s]   (F2: %s | F3: diag | Esc: clear | Ctrl+C: quit)\n",
...
int wmain() {
    ...
    ::SetConsoleTitleW(L"KieeKey v1.1.0 - engine demo");
