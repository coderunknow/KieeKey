...
//
//   2. Tone-key Restore re-issue: after an engine Restore the hook re-sends
...
//
//   3 (v3.1, P0). D1/D2/D3/D4 contract fixes found by the 3-way benchmark:
...
//
// (v1.1.1: the former section 2 — the CtrlShiftChord clean-chord toggle
//  tests — was removed together with the feature: the global Ctrl+Shift
//  toggle hotkey no longer exists in the app.)
//----------------------------------------------------------------------------
...
int main() {
    ...
    //===================================================================
    // 2. Tone-key Restore re-issue — the "chào -> chaof", "chàf -> chaf",
    ...
    //===================================================================
    std::printf("[2] tone-key Restore re-issue (chào+BS+f / chaof / cass)\\n");
