...
//============================================================================
//----------------------------------------------------------------------------
// KieeKey v1.1.0 — ModernKeyHook.hpp
...
public:
    ...
    // foreground change — the same treatment the Ctrl+Shift chord tracker
    // already received in v1.1.0 for the same missed-key-up class.
    //
    // Threading: hook pump thread only (the producer handler runs there,
    // serialized with the LL callbacks and applyModifierDelta).
    //-------------------------------------------------------------------------
